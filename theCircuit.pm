...
sub new{## constrcutor
    ...
    my $self = bless { 
			...
			fedby_modules=> $args->{fedby_modules},
			fedby_modules_inst=> $args->{fedby_modules_inst},
			fwd_modules=> $args->{fwd_modules},
			fwd_modules_inst=> $args->{fwd_modules_inst},
...
sub get_fedby_modules{
   my $self = shift;
    return @{$self->{fedby_modules}};
}
sub set_fedby_modules{
   my ($self,$new_fedby_modules) = @_;
   $self->{fedby_modules} = $new_fedby_modules;
}
sub get_fedby_modules_inst{
   my $self = shift;
   return @{$self->{fedby_modules_inst}};
}
sub set_fedby_modules_inst{
   my ($self,$new_fedby_modules_inst) = @_;
   $self->{fedby_modules_inst} = $new_fedby_modules_inst;
}

sub get_fwd_modules{
   my $self = shift;
   return @{$self->{fwd_modules}};
}
sub set_fwd_modules{
   my ($self,$new_fwd_modules) = @_;
   $self->{fwd_modules} = $new_fwd_modules;
}
sub get_fwd_modules_inst{
   my $self = shift;
   return @{$self->{fwd_modules_inst}};
}
sub set_fwd_modules_inst{
   my ($self,$new_fwd_modules_inst) = @_;
   $self->{fwd_modules_inst} = $new_fwd_modules_inst;
}
